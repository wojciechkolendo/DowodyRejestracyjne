...
public final class NRV2EDecompressor {
  ...
  /**
   * Entry point for standalone testing of NRV2E decompressor,
   * just provide a binary file to be decoded as an argument.
   */
  public static void main(String[] args) throws Exception {
    RandomAccessFile f = new RandomAccessFile(args[1], "r");
    byte[] a = new byte[(int) f.length()];
    f.readFully(a);
    byte[] b = NRV2EDecompressor.decompress(a);
    String out = new String(b, "UnicodeLittle");
